...
import com.example.ux32vd.geofunny.RecyclerViewAdapterBangunRuang;
...
public class MenuBangunRuang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerViewAdapterBangunRuang myAdapter = new RecyclerViewAdapterBangunRuang(this,listMenu);
